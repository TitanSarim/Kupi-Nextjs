...
const TransactionDetailDialgue : React.FC<DialogProps> = ({ open, onClose, TransactionData }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50 duration-700 ease-out">
        <div className="lightGray py-6 px-8 rounded-lg shadow-lg transaction_dialguebox flex flex-col gap-2 duration-700 ease-out">
            ...
            <div className='bg-white rounded-lg px-8 py-4 flex flex-col items-start justify-center gap-4 border-2'>
                ...
                <div className='w-full flex flex-wrap justify-between gap-4'>
                    ...
                    <div className='w-5/12'>
                        ...
                        <span>${TransactionData?.tickets && TransactionData?.tickets[0].priceDetails.totalPrice}</span>
                    </div> 
                    <div className='w-5/12'>
                    ...
                    <div className='w-5/12'>
                        ...
                        <span>${TransactionData?.tickets && TransactionData?.tickets[0].priceDetails.kupiProfit}</span>
                    </div>
                </div>
