          ...
          <div className='w-3/12'>
              ...
              <Popover open={open} onOpenChange={setOpen}>
                <PopoverTrigger asChild className='w-full  h-12 rounded-lg  text-gray-500 border-gray-700'>
                    <Button variant="outline" role="combobox" aria-expanded={open} className="w-full justify-between outline-none">
                ...
                <PopoverContent className="w-full p-0 select-dropdown">
                    ...
                    <CommandList className='w-full'>
                        ...
                        >
                            <Check className={`mr-2 h-4 w-4 ${destinationCity === "" ? 'opacity-100' : 'opacity-0'}`}/>
                            Clear
                        </CommandItem>
                        {cities.map((city) => (
                            <CommandItem
