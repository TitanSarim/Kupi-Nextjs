  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-gray-300 text-white hover:bg-gray-300 hover:text-white focus:bg-gray-900 focus:text-white dark:bg-gray-50 dark:text-gray-900 dark:hover:bg-gray-50 dark:hover:text-gray-900 dark:focus:bg-gray-50 dark:focus:text-gray-900",
